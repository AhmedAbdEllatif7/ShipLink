...
<body class="bg-slate-50 text-slate-800 antialiased h-screen flex overflow-hidden">
    ...
    <aside class="w-64 bg-slate-900 text-white flex flex-col hidden lg:flex transition-all duration-300">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.dashboard') ? 'bg-indigo-600 font-bold shadow-lg shadow-indigo-600/30' : 'font-semibold text-slate-400 hover:bg-slate-800 hover:text-white' }} rounded-xl text-sm transition-colors">
            ...
            @can('view users')
            <a href="{{ route('admin.users.index') }}" class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.users.*') ? 'bg-indigo-600 font-bold shadow-lg shadow-indigo-600/30 text-white' : 'font-semibold text-slate-400 hover:bg-slate-800 hover:text-white' }} rounded-xl text-sm transition-colors">
            ...
            @can('view roles')
            <a href="{{ route('admin.roles.index') }}" class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.roles.*') ? 'bg-indigo-600 font-bold shadow-lg shadow-indigo-600/30 text-white' : 'font-semibold text-slate-400 hover:bg-slate-800 hover:text-white' }} rounded-xl text-sm transition-colors">
            ...
            <a href="{{ route('admin.permissions.index') }}" class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.permissions.*') ? 'bg-indigo-600 font-bold shadow-lg shadow-indigo-600/30 text-white' : 'font-semibold text-slate-400 hover:bg-slate-800 hover:text-white' }} rounded-xl text-sm transition-colors">
            ...
            <a href="{{ route('admin.shipments.index') }}" class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.shipments.*') ? 'bg-indigo-600 font-bold shadow-lg shadow-indigo-600/30 text-white' : 'font-semibold text-slate-400 hover:bg-slate-800 hover:text-white' }} rounded-xl text-sm transition-colors text-sm">
