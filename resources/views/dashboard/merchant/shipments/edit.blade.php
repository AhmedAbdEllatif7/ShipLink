    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <h2 class="text-2xl font-semibold mb-6 border-b pb-4">تعديل الشحنة: {{ $shipment->tracking_number }}</h2>

                <form action="{{ route('merchant.shipments.update', $shipment->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="receiver_name" id="receiver_name" value="{{ old('receiver_name', $shipment->receiver_name) }}" 
                        ...
                        <div>
                            ...
                            <select name="city" id="city" 
                                ...
                                @php
                                    ...
                                    $currentCity = old('city', $shipment->city);
                                @endphp
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="receiver_address" id="receiver_address" rows="3" 
                                class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('receiver_address') border-red-500 @enderror" required>{{ old('receiver_address', $shipment->receiver_address) }}</textarea>
                        ...
                        <div>
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="cod_amount" id="cod_amount" step="0.01" value="{{ old('cod_amount', $shipment->cod_amount) }}" 
